...
// setup.php vive en la RAÍZ de este subdominio (.../public_html/anonimiza/).
// Subir DOS niveles llega a .../domains/utilix.uno/, fuera de lo que
// cualquier despliegue estático de este sitio pueda borrar.
$FUERA = dirname(dirname(__DIR__));

$PROV = [
  'claude' => [
    'nombre' => 'Anthropic (Claude)',
    'out'    => $FUERA . '/anthropic_api_key.php',
    'in'     => __DIR__ . '/datos/anthropic_config.php',
  ],
  'gemini' => [
    'nombre' => 'Google (Gemini)',
    'out'    => $FUERA . '/gemini_api_key.php',
...
<title>Activar la IA — AnonimizaPDF</title>
<style>
  :root{--bg:#0f1115;--card:#171a21;--tx:#e7e9ee;--mu:#9aa3b2;--ac:#2148d1;--ok:#2fa46a;--wa:#d08b28}
...
<div class="card">
  <h1>Activar la inteligencia artificial de AnonimizaPDF</h1>
  ...
  <?php if ($tieneClaude || $tieneGemini): ?>
    <p>Ya puedes usar la herramienta en <a href="app.html">app.html</a>. Por seguridad, cuando termines
  ...
  <?php else: ?>
    ...
    Claude es el motor por defecto y el recomendado para documentos con datos personales.</p>
  <?php endif; ?>
